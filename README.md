...
- **Trek, speaker and gallery tiles** — the images on the trek, speaker and
  case-comp pages are dark SVG placeholders in `assets/img/`. Drop in real
  photos and update the `<img src>` paths in `src/pages/`.
...
- **Photos** — drop photos into `carousel/`, run
  ...
  reference the same `assets/img/carousel/` files.
